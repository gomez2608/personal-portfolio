...
const experiences: Experience[] = [
    {
        ...
        company: "Provectus",
        jobDescription: "ML Engineer specializing in GenAI solutions, leveraging AWS services to build, optimize, and deploy production-ready LLM applications with a focus on agentic workflows and model fine-tuning.",
        bp: [
