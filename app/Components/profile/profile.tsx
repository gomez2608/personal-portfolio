...
export default function Profile() {
    return(
        <section className="flex flex-col justify-items-start mx-[181px] mt-[133px]">
...
function Networks(){
    ...
    return (
        <div className='flex flex-row items-center justify-between gap-4 me-[100px]'>
            <Button 
            className='bg-background border-1 border-buttonwhite text-buttonwhite w-[210px] h-[49px] items-center hover:bg-accent'
